...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EnochTech learning hub is an AI-powered platform that creates personalized study plans from your content." },
      { name: "author", content: "Enoch (Etek)" },
      { property: "og:title", content: "Etek Learning Hub — AI-paced learning" },
      { property: "og:description", content: "EnochTech learning hub is an AI-powered platform that creates personalized study plans from your content." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Etek Learning Hub — AI-paced learning" },
      { name: "twitter:description", content: "EnochTech learning hub is an AI-powered platform that creates personalized study plans from your content." },
